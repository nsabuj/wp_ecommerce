...
function wc_customize_product_sorting($sorting_options){
    $sorting_options = array(
        'menu_order' => __( 'Sorting', 'marketo' ),
        'popularity' => __( ' Popularity', 'marketo' ),
        'rating'     => __( ' Average rating', 'marketo' ),
        'date'       => __( ' Newness', 'marketo' ),
        'price'      => __( 'Price: low to high', 'marketo' ),
        'price-desc' => __( 'Price: high to low', 'marketo' ),
    );
