(function ($) {
    ...
    // shop filter
    var xs_notic_wrapper = $('.woocommerce-notices-wrapper');
    xs_notic_wrapper.remove();
    $('.xs-shop-notice').append(xs_notic_wrapper);
    var ordaring = $('.before-default-sorting');
    ordaring.remove();
    $('.woocommerce-ordering').prepend(ordaring);
